...
path_figure <- "/root/Project/BANSMA/simulation/p50q4n60/figure"
...
for (r in 1:25) {
    ...
    load(paste(path_result,"/BA_Setting_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
    truemat = rbind(truemat,true.out)

    load(paste(path_result,"/BA_BANSMA_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
    bansmaIE = rbind(bansmaIE,bansma.out$IE)
    bansmaIED = rbind(bansmaIED,bansma.out$IED)
    bansmaIEC = rbind(bansmaIEC,bansma.out$IEC)
    
    load(paste(path_result,"/BA_BANSMAProbit_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
    ...
    load(paste(path_result,"/BA_BAMA_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
    bamaIED = rbind(bamaIED,bama.out)

    load(paste(path_result,"/BA_Mediate_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
...
pdf(paste(path_figure,"/BA_Probit_Setting_p",p,"q",q,"n",n,".pdf",sep=""),width=12,height=4)
...
pdf(paste(path_figure,"/BA_Setting_p",p,"q",q,"n",n,".pdf",sep=""),width=12,height=4)

...
save(fit.med,fitProbit.out,bansmaProbit.out,file=paste(path_result,"/BA_BANSMAProbit_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
# save(fit.med,fit.out,fitProbit.out,bansma.out,bansmaProbit.out,file=paste(path_result,"/BA_BANSMAProbit_p",p,"q",q,"n",n,"r",r,".RData",sep=""))

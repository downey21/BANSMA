...
# Graph generation
set.seed(77109)
sim  = simul.Chaingraph(p,q,pE,scale.free=F)
...
pdf("/root/Project/BANSMA/simulation/p50q4n200/figure/ER_p50q4.pdf")
...
save(sim,dat,chlist,palist,true.out,file=paste(path_result,"/ER_Setting_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
...
save(fit.med,fit.out,bansma.out,file=paste(path_result,"/ER_BANSMA_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
...
save(bama.out,file=paste(path_result,"/ER_BAMA_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
...
save(med.single.out,file=paste(path_result,"/ER_Mediate_p",p,"q",q,"n",n,"r",r,".RData",sep=""))
